...
public partial class UICodeSpawner
{
    ...
    static void SpawnCodeForDlg(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UI/" + strDlgName ;
	    ...
	    strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UI/" + strDlgName + "/" + strDlgName + "System.cs";
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UI/" + strDlgName + "/Event" ;
	    ...
	    strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UI/" + strDlgName + "/Event/" + strDlgName + "EventHandler.cs";
        if(System.IO.File.Exists(strFilePath))
        {
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UI/" + strDlgName  ;
	    ...
	    strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UI/" + strDlgName  + "/" + strDlgName  + ".cs";
        if(System.IO.File.Exists(strFilePath))
        {
	        Debug.LogError("已存在 " + strDlgName + ".cs,将不会再次生成。");
            return;
    ...
    static void SpawnCodeForDlgBehaviour(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UIBehaviour/" + strDlgName;

        if ( !System.IO.Directory.Exists(strFilePath) )
        {
	        System.IO.Directory.CreateDirectory(strFilePath);
        }
	    strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UIBehaviour/" + strDlgName + "/" + strDlgComponentName + "System.cs";
    ...
    static void SpawnCodeForDlgComponentBehaviour(GameObject gameObject)
    {
	    ...
	    string strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UIBehaviour/" + strDlgName;
	    if ( !System.IO.Directory.Exists(strFilePath) )
	    {
		    System.IO.Directory.CreateDirectory(strFilePath);
	    }
	    strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UIBehaviour/" + strDlgName + "/" + strDlgComponentName + ".cs";
	    StreamWriter sw = new StreamWriter(strFilePath, false, Encoding.UTF8);
	    StringBuilder strBuilder = new StringBuilder();
	    strBuilder.AppendLine()
		    .AppendLine("using UnityEngine;");
