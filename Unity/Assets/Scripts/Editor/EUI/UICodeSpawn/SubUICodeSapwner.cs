...
public partial class UICodeSpawner
{
    ...
    static void SpawnCodeForSubUI(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UIBehaviour/CommonUI" +
                             "";
        ...
        strFilePath     = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UIBehaviour/CommonUI/" + strDlgName + "ViewSystem.cs";
    ...
    static void SpawnCodeForSubUIBehaviour(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UIBehaviour/CommonUI";

        if ( !System.IO.Directory.Exists(strFilePath) )
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UIBehaviour/CommonUI/" + strDlgName + ".cs";
