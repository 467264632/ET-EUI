...
public partial class UICodeSpawner
{
    ...
    static void SpawnCodeForScrollLoopItemViewSystem(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UIItemBehaviour";

        if ( !System.IO.Directory.Exists(strFilePath) )
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath     = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Game/UIItemBehaviour/" + strDlgName + "ViewSystem.cs";
    ...
    static void SpawnCodeForScrollLoopItemBehaviour(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UIItemBehaviour";

        if ( !System.IO.Directory.Exists(strFilePath) )
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath     = Application.dataPath + "/Scripts/Codes/ModelView/Client/Game/UIItemBehaviour/" + strDlgName + ".cs";
        StreamWriter sw = new StreamWriter(strFilePath, false, Encoding.UTF8);
