...
namespace ET.Client
{
    // [Callback(TimerCallbackId.BattleRound)]
    ...
    public static class AdventureComponentSystem
    {
        ...
        {
            uint seed = (uint) UnitHelper.GetMyUnitFromCurrentScene(self.ClientScene().CurrentScene()).GetComponent<NumericComponent>().GetAsInt(NumericType.BattleRandomSeed);
            if (self.Random == null)
            {
        ...
        public static void ResetAdventure(this AdventureComponent self)
        {
            ...
            {
                self.ClientScene().CurrentScene().GetComponent<UnitComponent>().Remove(self.EnemyIdList[i]);
            }
            ...
            EventSystem.Instance.PublishAsync(self.ClientScene(), new EventType.SceneChangeFinish()).Coroutine();
        }
        ...
        //     self.BattleTimer = TimerComponent.Instance.NewOnceTimer(TimeHelper.ServerNow() + 500, TimerCallbackId.BattleRound, self);
        // }
        
        
        // public static  void  ShowAdventureHpBarInfo(this AdventureComponent self,bool isShow)
        // {
        //     Unit myUnit = UnitHelper.GetMyUnitFromCurrentScene(self.ClientScene().CurrentScene());
        //     ShowAdventureHpBar.Instance.Unit = myUnit;
        //     ShowAdventureHpBar.Instance.isShow = isShow;
        //      EventSystem.Publish(ShowAdventureHpBar.Instance);
        //     for ( int i = 0; i < self.EnemyIdList.Count; i++ )
        //     {
        ...
        //         EventSystem.PublishClass(ShowAdventureHpBar.Instance);
        //     }
        // }
        //
        //
        ...
        //         EventSystem.Instance.PublishAsync(self.ClientScene(), new EventType.AdventureBattleRoundView()
        //         {
        //             ZoneScene = self.ClientScene(), AttackUnit = unit, TargetUnit = monsterUnit
        //         }).Coroutine();
        //         
        //         await EventSystem.Instance.Publish(self.ClientScene(), new EventType.AdventureBattleRound()
        //         {
        //             ZoneScene = self.ClientScene(), AttackUnit = unit, TargetUnit = monsterUnit
        //         });
        //         
